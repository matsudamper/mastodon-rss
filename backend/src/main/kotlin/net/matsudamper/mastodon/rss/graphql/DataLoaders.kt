...
import net.matsudamper.mastodon.rss.dataloader.NoteStampsDataLoaderDefine
...
class DataLoaders(
    ...
    val noteStampsDataLoader by register { NoteStampsDataLoaderDefine(diContainer.noteStampRepository) }
