 ...
 *
 * @param afterActorUrl このアクター URL の次から返す
 */
@Serializable
data class FollowersCursor(
    @SerialName("afterActorUrl")
    val afterActorUrl: String,
) {
    fun encode(): String =
    ...
    companion object {
         ...
         */
        fun decode(value: String): FollowersCursor? {
