...
公開鍵を取りに行けない。フォローを受けたときと反応を受けたときの鍵をどちらも
残してあるので、記録のある相手ならそれで検証して、フォローと反応を消す。
反応だけを押した相手の鍵を残さないと、消えた相手の反応が公開画面に出たままになる。
記録した鍵を
...
フォローも反応も残っていない相手の鍵は引かない。関わりの切れた相手の鍵を返すと、
